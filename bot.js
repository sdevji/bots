...
client.on("ready", async () => {
  client.user.setPresence({game: {name: "Boba's Payouts", type: 1}});
...
async function sendMessage () {
  let embed = new Discord.RichEmbed().setThumbnail('https://www.bobasalliance.com/wp-content/uploads/2020/01/bobasbot.png');
  ...
  embed.setFooter('Last refresh', 'https://www.bobasalliance.com/wp-content/uploads/2020/01/bobasbot.png');
  embed.setTimestamp();
